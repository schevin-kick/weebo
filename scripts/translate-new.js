/**
 * DeepL Translation Script for New Translations
 *
 * This script translates new English strings to Traditional Chinese
...
const SOURCE_FILE = path.join(__dirname, '../new-translations-en.json');
const OUTPUT_FILE = path.join(__dirname, '../new-translations-zh-tw.json');
 ...
 */
async function main() {
  console.log('🌐 DeepL Translation Script for New Translations\n');
