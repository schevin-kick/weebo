/**
 * DeepL Translation Script for SEO Metadata
 *
 * This script translates English SEO metadata strings to Traditional Chinese
...
const SOURCE_FILE = path.join(__dirname, '../new-seo-translations-en.json');
const OUTPUT_FILE = path.join(__dirname, '../new-seo-translations-zh-tw.json');
 ...
 */
async function main() {
  console.log('🌐 DeepL Translation Script for SEO Metadata\n');
