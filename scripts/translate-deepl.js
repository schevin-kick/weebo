/**
 * DeepL Translation Script for zh-tw.json
 *
 * This script translates the English translation file (en.json) to Traditional Chinese
 * using the DeepL API, preserving the nested JSON structure and special formatting.
 */
...
const SOURCE_FILE = path.join(__dirname, '../src/messages/en.json');
const OUTPUT_FILE = path.join(__dirname, '../src/messages/zh-tw-deepl.json');
 ...
 */
async function main() {
  console.log('🌐 DeepL Translation Script for zh-tw.json\n');
