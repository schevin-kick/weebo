/**
 * DeepL Translation Script for Backend Translations
 *
 * This script translates backend English strings to Traditional Chinese
...
const SOURCE_FILE = path.join(__dirname, '../backend-translations-en.json');
const OUTPUT_FILE = path.join(__dirname, '../backend-translations-zh-tw.json');
 ...
 */
async function main() {
  console.log('🌐 DeepL Translation Script for Backend Translations\n');
